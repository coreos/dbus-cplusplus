...
{{/FOR_EACH_METHOD}}
    ...
    {
{{#FOR_EACH_METHOD}}
        static ::DBus::IntrospectedArgument {{METHOD_NAME}}_args[] =
        {
    {{#FOR_EACH_METHOD_ARG}}
...
{{/FOR_EACH_METHOD}}
{{#FOR_EACH_SIGNAL}}
        static ::DBus::IntrospectedArgument {{SIGNAL_NAME}}_args[] =
        {
    {{#FOR_EACH_SIGNAL_ARG}}
...
{{/FOR_EACH_SIGNAL}}
        static ::DBus::IntrospectedMethod {{CLASS_NAME}}_adaptor_methods[] =
        {
{{#FOR_EACH_METHOD}}
...
{{/FOR_EACH_METHOD}}
        ...
        static ::DBus::IntrospectedMethod {{CLASS_NAME}}_adaptor_signals[] =
        {
{{#FOR_EACH_SIGNAL}}
...
{{/FOR_EACH_SIGNAL}}
        ...
        static ::DBus::IntrospectedProperty {{CLASS_NAME}}_adaptor_properties[] =
        {
{{#FOR_EACH_PROPERTY}}
...
{{/FOR_EACH_PROPERTY}}
        ...
        static ::DBus::IntrospectedInterface {{CLASS_NAME}}_adaptor_interface =
        {
            "{{INTERFACE_NAME}}",
